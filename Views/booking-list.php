                                   ...
                                   <tr>
                                        ...
                                        <td>
                                             <form action="<?php echo FRONT_ROOT . "Message/getMessage" ?>" method="post">
                                                  <input type="hidden" name="id_user" value="<?php echo  $_SESSION["loggedUser"]->getId() ?>">
                                                  <input type="hidden" name="id_user_keeper" value="<?php echo $booking->getKeeper()->getUser()->getId() ?>">
