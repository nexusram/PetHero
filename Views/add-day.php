          ...
          <div class="container">
               ...
               <form action="<?php echo FRONT_ROOT . "Day/Add" ?>" method="post" class="bg-light-alpha p-5">
                    ...
                    <div class="d-flex justify-content-between">
                     <a class="btn btn-danger" width="20" href="<?php echo FRONT_ROOT . "Day/ShowListView" ?>">Cancel</a>
                    <button type="submit" name="button" class="btn btn-success ml-auto d-block text-center">
                         <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-check-lg bi bi-box-arrow-in-left" viewBox="0 0 16 16">
