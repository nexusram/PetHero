<div>
    ...
    <a class="btn btn-success" href="<?php echo  FRONT_ROOT . "Booking/ShowConfirmedView"?>">
    ...
    <a class="btn btn-warning" href="<?php echo FRONT_ROOT . "Booking/ShowInWaitView"?>">
    ...
    <a class="btn btn-danger" href="<?php echo FRONT_ROOT . "Booking/ShowDeclinedView"?>">
    ...
    <a class="btn btn-secondary" href="<?php echo FRONT_ROOT. "Booking/ShowHistoryView"?>">
