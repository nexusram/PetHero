...
<main class="py-5">
     <section id="listado" class="mb-5">
          <div class="container">
               <h2 class="mb-4">Booking's Accepted by my</h2>
               ...
               <div>
                    ...
                    <a class="btn btn-warning" href="<?php echo FRONT_ROOT."Booking/ShowInWait"?>">
                    ...
                    <a class="btn btn-danger" href="<?php echo FRONT_ROOT."Booking/ShowRefused"?>">
