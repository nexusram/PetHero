...
$keeperController = new KeeperController();
 $keeperController->CheckUser($_SESSION["loggedUser"]->getId());
?>
<nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
   ...
   if ($keeperController->CheckUser($_SESSION["loggedUser"]->getId()) == false) {
     ?>
          <ul class="navbar-nav">
               <li class="nav-item">
                    <a class="btn btn-warning" href="<?php echo FRONT_ROOT . "Keeper/Check" ?>">
